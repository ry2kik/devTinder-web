                ...
                <div className='w-4/5'>
                    ...
                    <div className='flex justify-between gap-8'>
                        <div className='flex flex-col'>
                            ...
                            <input
                                type="text"
                                className='border-b-2 border-gray-300 focus:outline-0 mt-1'
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input
                                type="text"
                                className='border-b-2 border-gray-300 focus:outline-0 mt-1 w-5/6'
                                value={user.lastName}
                            />
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col mt-5'>
                        <label className='text-gray-400 uppercase'>skills</label>
                        <input
                            type="text"
                    ...
                    <div className='relative'>
                        <motion.button
                            ...
                            className='absolute top-5 -right-40 cursor-pointer font-bold text-xl bg-linear-65 from-purple-500 to-pink-500 px-10 py-3 text-white' onClick={() => setShowModal(true)}
